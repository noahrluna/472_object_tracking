...
def small_move_up(device, velocity=0.5, duration=1, log=None):
    """
    ...
    move_local(device, 0, 0, velocity, duration, log)


def small_move_down(device, velocity=0.5, duration=1, log=None):
    """
    Moves drone upwards by a small amount.
    To move by a larger amount, set velocity and/or duration to something bigger.
    """
...
def small_move_forward(device, velocity=0.5, duration=1, log=None):
    """
    ...
    move_local(device, velocity, 0, 0.0, duration, log)


def small_move_back(device, velocity=0.5, duration=1, log=None):
    """
...
def small_move_right(device, velocity=0.5, duration=1, log=None):
    """
    ...
    move_local(device, 0, velocity, 0.0, duration, log)


def small_move_left(device, velocity=0.5, duration=1, log=None):
    """
